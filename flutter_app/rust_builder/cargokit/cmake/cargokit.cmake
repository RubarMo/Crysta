...
function(apply_cargokit target manifest_dir lib_name any_symbol_name)
    ...
    if (WIN32)
        execute_process(COMMAND powershell -ExecutionPolicy Bypass -File "${cargokit_cmake_root}/cmake/resolve_symlinks.ps1" "${CARGOKIT_MANIFEST_DIR_ABS}" OUTPUT_VARIABLE CARGOKIT_MANIFEST_DIR_ABS OUTPUT_STRIP_TRAILING_WHITESPACE)
    else()
        get_filename_component(CARGOKIT_MANIFEST_DIR_ABS "${CARGOKIT_MANIFEST_DIR_ABS}" REALPATH)
    endif()
